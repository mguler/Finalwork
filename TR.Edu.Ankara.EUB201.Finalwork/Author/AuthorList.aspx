<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AuthorList.aspx.cs" Inherits="TR.Edu.Ankara.EUB201.Finalwork.Author.AuthorList" %>
        ...
        <div>
            <asp:GridView ID="GridView1" runat="server" PageSize="25" AllowPaging="True" AllowCustomPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="GridView1_PageIndexChanging">
                <Columns>
                    ...
                    <asp:HyperLinkField DataNavigateUrlFields="Id" DataNavigateUrlFormatString="~/Author/AuthorEdit.aspx?Id={0}" Text="Düzenle" />
                </Columns>
            </asp:GridView>
